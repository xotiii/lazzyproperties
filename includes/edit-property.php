...
<div class="form-group">
<?php echo edit_property();?>
    <label for="Lastname">Title</label>
    <input type="text" data-parsley-validate-if-empty  required class="form-control" value="<?php edit_property_data('Title')?>" name="post_title" placeholder="Title">
</div>
<div class="form-group">
    <label for="Firstname">Price</label>
    <input type="number"  data-parsley-validate-if-empty data-parsley-pattern="^[0-9]+$"  data-parsley-type="digits" required class="form-control" value="<?php edit_property_data('Price');?>" name="post_price" placeholder="&#8369 Price">
</div>
<div class="form-group">
    <label for="Firstname">Type</label>
     <select id="lunchBegins" data-parsley-validate-if-empty class="selectpicker" name="post_type" title="Select Type">
                                        ...
                                        <option value="a" <?php edit_property_data('Type1');?>>For Sale</option>
                                        <option value="b" <?php edit_property_data('Type2');?>>For Rent</option>
...
<div class="form-group">
   ...
   <textarea class="form-control" data-parsley-validate-if-empty rows="5" value="<?php edit_property_data('Description');?>" name="post_description" id="comment"><?php nl2br(edit_property_data('Description'));?></textarea>
</div>

<div class="form-group">
    <label for="Firstname">Location</label>
    <input type="text" class="form-control" onFocus="geolocate()" id="autocomplete" name="post_location" placeholder="Address"></input>
	<input type="hidden"  id="country" value="<?php edit_property_data('Country');?>" name="post_country" ></input>
	<input type="hidden" id="postal_code" value="<?php edit_property_data('Zip');?>" name="post_zip" ></input>
	<input type="hidden" id="administrative_area_level_1" value="<?php edit_property_data('State');?>" name="post_state" ></input>
	<input type="hidden" id="locality" value="<?php edit_property_data('City');?>" name="post_city" ></input>
	<input type="hidden" id="route" value="<?php edit_property_data('StreetAddress');?>" name="post_route" ></input>
...
<div class="form-group">
    ...
    <input type=""text" required class="form-control" id="lat" value="<?php edit_property_data('Latitude');?>"name="post_lat" disabled></input>
</div>
<div class="form-group">
    <label for="Lastname">Longitude</label>
    <input type=""text" required class="form-control" id="long" value="<?php edit_property_data('Longitude');?>" name="post_long" disabled></input>
</div>
...
<div class="form-group">
   ...
   <div class="row">
        <div class="col-xs-6 form-group">
            <label>Stories</label>
            <input class="form-control" data-parsley-validate-if-empty type="number" data-parsley-pattern="^[0-9]+$" placeholder="No. of Stories" value="<?php edit_property_data('Stories');?>" name="post_stories"/>
        </div>
        <div class="col-xs-6 form-group">
            <label>Bed</label>
            <input class="form-control" data-parsley-validate-if-empty type="number" data-parsley-pattern="^[0-9]+$" placeholder="No. of Bedrooms" value="<?php edit_property_data('Bed');?>" name="post_bed"/>
        </div>
        <div class="col-xs-6 form-group">
            <label>Baths</label>
            <input class="form-control" data-parsley-validate-if-empty type="number" data-parsley-pattern="^[0-9]+$" placeholder="No. of Bathrooms" value="<?php edit_property_data('Bath');?>" name="post_bath"/>
        </div>

        <div class="col-xs-6 form-group">
            <label>Garage</label>
            <input class="form-control" data-parsley-validate-if-empty type="number" data-parsley-pattern="^[0-9]+$" placeholder="No. of Cars fit in Garage" value="<?php edit_property_data('Garage');?>" name="post_garage"/>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <input type="number" required class="form-control" data-parsley-pattern="^[0-9]+$" data-parsley-validate-if-empty value="<?php edit_property_data('Land');?>" name="post_land" placeholder="Land Size">
</div>

<div class="form-group">
    <label for="Firstname">Floor Size</label>
    <input type="number" required class="form-control" data-parsley-pattern="^[0-9]+$"  data-parsley-validate-if-empty value="<?php edit_property_data('Floor');?>" name="post_floor" placeholder="Floor Size">
</div>

<div class="text-center">
	
    <button type="submit" id="btn" name="edit_submit"  data-parsley-validate-if-empty class="btn btn-default">Save Post</button>
</div>
</form>
